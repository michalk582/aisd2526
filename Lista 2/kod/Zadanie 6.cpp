...
void runTest(Func func, string name, DataVector data) {
    ...
    // Wypisujemy w formacie CSV do wykresu: Nazwa, Czas
    cout << left << setw(25) << name << " " << elapsed.count() << " ms"<< endl;
}

int main() {
    //funkcje standaryzowane do jednego typu danych
    const int N = 1000000; // 1 mln elementów
    cout << "Test algorytmow dla n = " << N << " (Wszystko na float)" << endl;
